  ...
  @ApiProperty({
    ...
    example: [
      ...
      },
      {
        ...
        title: 'Seoul Moment',
        content: 'Seoul Moment news content',
      },
      {
...
export class PostAdminNewsInfo {
  @ApiProperty({
    description: '언어 ID',
    example: 1,
  })
...
export class PostAdminNewsSectionInfo {
  @ApiProperty({
    description: '언어 ID',
    example: 1,
  })
...
export class PostAdminNewsSection {
  @ApiProperty({
    description: '다국어 섹션 정보 리스트 (한국어, 영어, 중국어)',
    type: [PostAdminNewsSectionInfo],
    example: [
      {
        languageId: 1,
  ...
  @Type(() => PostAdminNewsSectionInfo)
  @IsDefined()
  textList: PostAdminNewsSectionInfo[];
...
export class PostAdminNewsRequest {
  @ApiProperty({
    description: '카테고리 id',
    example: 1,
  })
...
export class GetAdminNewsInfoText {
  ...
  static from(
    ...
    const titleTexts = multilingualText.newsText.filter(
      (text) => text.fieldName === 'title',
    );
    const contentTexts = multilingualText.newsText.filter(
    ...
    return plainToInstance(this, {
      ...
      section: entity.section.map((section) =>
        GetAdminNewsSection.from(section, multilingualText.sectionText),
      ),
    });
  }
}

export class GetAdminNewsInfoResponse {
  @ApiProperty({
    description: '뉴스 ID',
    example: 1,
  })
